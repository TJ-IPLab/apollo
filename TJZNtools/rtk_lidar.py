...
if __name__ == '__main__':
    ...
    #f=open('testg.txt','w')
    fimu=open('/apollo/TJZNtools/data/gnssimu.txt','w')
    fbestpose=open('/apollo/TJZNtools/data/gnssbestpose.txt','w')
    fheading=open('/apollo/TJZNtools/data/gnssheading.txt','w')
    fpose=open('/apollo/TJZNtools/data/localizationpose.txt','w')
